    ...
    def process_hiv_documents(self) -> List[Dict[str, Any]]:
        ...
        for doc_info in hiv_docs:
            ...
            for doc in documents:
                ...
                # Store scenario category for filtering
                # scenario_categories is a string (e.g. "immediate_followup"), not a list
                doc["metadata"]["scenario_category"] = doc_info["scenario_categories"]
